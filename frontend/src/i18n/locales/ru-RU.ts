export default {
  ...
  settings: {
    ...
    parser: {
	  ...
	  chatPolicyTitle: 'Политика обработки вложений чата',
	  chatPolicyDescription: 'Задайте парсер по умолчанию для каждого типа вложений чата на уровне пространства. Отдельные агенты могут переопределить эти правила.',
	  chatPolicySaved: 'Политика обработки вложений сохранена',
