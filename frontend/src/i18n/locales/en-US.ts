export default {
  ...
  settings: {
    ...
    parser: {
	  ...
	  chatPolicyTitle: 'Chat attachment parser policy',
	  chatPolicyDescription: 'Set the default parser per file type for chat attachments at the workspace level. Individual agents can override these rules.',
	  chatPolicySaved: 'Chat attachment parser policy saved',
